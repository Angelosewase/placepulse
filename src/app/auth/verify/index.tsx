...
import { forgotPasswordService, verifyCodeService } from "../../../services/auth.service";
      ...
      <div className="w-full md:w-[45%] h-[90%] flex flex-col">
        ...
        >
          ...
          <div className="w-full flex justify-center">
            <button onClick={handleResend} type="button" className="text-[#FF8682] font-extrabold text-sm">Resend</button>
          </div>
          <button
            type="submit"
            disabled={loading}
