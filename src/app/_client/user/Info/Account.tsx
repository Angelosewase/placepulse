  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col gap-4 mt-6 shadow-sm shadow-[#c8c8c863] p-5 rounded-lg">
        <Fieldset legend="Name" className="w-full flex justify-between items-center">
        ...
        <Fieldset legend="Email" className="w-full flex justify-between items-center">
        ...
        <Fieldset legend="Password" className="w-full flex justify-between items-center">
        ...
        <Fieldset legend="Phone Number" className="w-full flex justify-between items-center">
            <h1 className="text-xl font-extrabold">{separatePhoneNumber(profile.phone)}</h1>
            <button className="flex gap-3 items-center px-5 py-3 border border-[#8DD3BB] rounded-sm">
                <HiPencilSquare color="black"/>
                <p className="text-sm font-bold">Change</p>
            </button>
