            ...
            <div className="w-full absolute bottom-0 flex justify-center">
                <div className="w-[85%] bg-white rounded-t-2xl p-6">
                    ...
                    <div className="w-full flex justify-between gap-4 mt-10">
                        <AnimatedSelect className="w-full" label="Hotels" value="" handleChange={()=> {}}/>
                        <AnimatedSelect label="Parks" className="w-full" value="" handleChange={()=> {}}/>
                        <AnimatedSelect label="Gardens" className="w-full" value="" handleChange={()=> {}}/>
                        <AnimatedSelect label="Restaurants" className="w-full" value="" handleChange={()=> {}}/>
                    </div>
                </div>
            </div>
        </div>
