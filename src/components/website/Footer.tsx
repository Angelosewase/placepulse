    ...
    return(
        <div className="w-full h-[60vh] relative flex items-start justify-between md:px-[10%] pt-44 bg-[#396ff965]">
            ...
            <div className="w-full md:w-[80%] h-[45vh] rounded-[1rem] p-5 absolute top-[-20vh] bg-[#5984f1a0]">
                <h1 className="md:w-1/5 w-full text-4xl font-extrabold">Subscribe Newsletter</h1>
                <div className="w-[50%] flex flex-col relative">
                    <h1 className="mt-[5%] font-extrabold text-[#112211]">The Travel</h1>
                    <p className="text-[#112211] font-semibold text-sm">Get inspired! Receive tour discounts, tips and good place to get reservation.</p>
                    <div className="w-full flex mt-2">
                        <input type="email" placeholder="Enter your email address" className="w-[60%] px-3 py-3 rounded-sm outline-none font-semibold"/>
                        <button className="bg-blue-500 text-white px-4 py-3 rounded-sm mx-2 font-semibold">Subscribe</button>
                    </div>
                </div>
                ...
                <div className="absolute z-50 top-5 right-10 bg-black w-1/3 rounded-tl-[3.4rem] rounded-tr-[3rem]">
                    ...
                    <img src={landingVector} className="absolute right-[-1rem] w-30 h-20 top-[50%]" alt="" />
                </div>
            </div>
        </div>
    )
