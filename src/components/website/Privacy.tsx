...
const PrivacyPolicy = () => {
    return (
        <div className="p-8 max-w-4xl mx-auto">
            <button className="absolute left-8 top-7" onClick={()=> history.back()}><BsArrowLeftCircle color="black" size={26}/></button>
            <h1 className="text-4xl font-bold mb-6">Privacy Policy</h1>

            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-2">Introduction</h2>
                <p className="text-gray-700">
                    Welcome to Place Pulse. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700">
                    ...
                    <li>Communicate with you about products, services, offers, promotions, rewards, and events offered by Place Pulse and others, and provide news and information we think will be of interest to you.</li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="text-gray-700">
                    <strong>Email:</strong> support@placepulse.com<br />
