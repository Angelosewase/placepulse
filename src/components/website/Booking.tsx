...
const BookingPage = () => {
  ...
  return (
    <div className="w-full md:px-12 pt-5 pb-[50vh]">
        ...
        <div className="w-full">
          ...
          <div className="w-full flex items-center justify-between mt-5">
            <div>
              ...
              <h1 className="text-2xl font-extrabold">{formatDate(checkIn, 'Check In')}</h1>
            ...
            <div>
              ...
              <h1 className="text-2xl font-extrabold">{formatDate(checkOut, 'Check Out')}</h1>
              <div className="border rounded-sm mt-4 p-3">
                <CheckInCheckOutDates value={checkOut} onChange={setCheckOut} />
              </div>
            </div>
          </div>
          <div className="w-full flex flex-col gap-2 mt-5">
            <div
              ...
              className={`w-full flex items-center justify-between px-3 rounded-lg py-3 cursor-pointer ${
                paymentPortion === 'full' ? 'bg-[#1877F2]' : " shadow shadow-gray-300"
              }`}
            >
              <div>
                <h1 className={`${paymentPortion === 'full' && 'text-white'} font-extrabold text-md`}>Pay in full</h1>
                <p className={`${paymentPortion === 'full' && 'text-white'} font-medium text-xs`}>Pay the total and you're all set</p>
              </div>
              <Radio
            ...
            <div
              ...
              className={`w-full flex items-center justify-between px-3 rounded-lg py-3 cursor-pointer ${
                paymentPortion === 'partial' ? 'bg-[#1877F2]' : " shadow shadow-gray-300"
              }`}
            >
              <div className="w-[70%]">
                <h1 className={`${paymentPortion === 'partial' && 'text-white'} font-extrabold text-md`}>Pay part now, part later</h1>
                <p className={`${paymentPortion === 'partial' && 'text-white'} font-medium text-xs`}>
                  Pay $207.43 now, and the rest ($207.43) will be automatically charged to the same payment method on Nov 14,
                  2022. No extra fees.
                </p>
                <button
      ...
      <div className="w-[30%] h-fit shadow shadow-[#c4c4c4] rounded-lg p-2">
        <div className='w-full flex justify-between gap-5'>
          ...
          <div className='flex flex-col'>
            ...
            <h1 className='text-lg font-extrabold'>{accommodation.roomTypes[0].type}</h1>
        ...
        <h1 className='text-sm font-medium text-[#112211]'>Your Booking is protected by <span className='text-black font-extrabold'>Place Pulse</span></h1>
        ...
        <div>
          ...
          <div className='w-full flex justify-between items-center mb-2'>
            ...
            <p className='text-md font-bold'>{accommodation.roomTypes[0].price}</p>
          </div>
          <div className='w-full flex justify-between items-center mb-2'>
