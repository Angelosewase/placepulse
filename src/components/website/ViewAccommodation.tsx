  ...
  return (
    <div className="w-full flex flex-col md:px-10 pt-10 pb-[50vh]">
      ...
      <div className="w-full mt-5">
        <HotelImageLayout images={accommodation.images} id={accommodation_id} />
      </div>
      ...
      <div className="w-full mt-5">
        <div className="w-full flex justify-between items-center">
          ...
          <Link
            to={`https://www.google.com/maps/place/${accommodation.location.text}`}
            target="_blank"
            className="px-6 py-3 rounded-sm flex items-center font-extrabold justify-center bg-[#396FF9] text-white text-sm"
          >
            View on google maps
      ...
      <div className="w-full mt-5">
        ...
        <div className="w-full grid md:grid-cols-3 gap-3 mt-4">
          {accommodation.free_bies.map((amenity) => {
            return (
              <div
                key={amenity}
