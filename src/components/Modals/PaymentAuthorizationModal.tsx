...
const PaymentAuthorizationModal = ({opened, close}: {opened: boolean; close: ()=> void})=>{
    const [loading] = useState(true);
    return(
        <div>
            <Modal opened={opened} onClose={close} closeOnClickOutside={false}>
                <div className="flex flex-col items-center gap-3">
                    <h1 className="">Please Authorize the payment amount on your Mobile Phone by entering your MTN MoMo Pin to confirm payment. Thank you.</h1>
                    <h1 className="font-extrabold">To approve your transaction dial *182*7*1#. Kwemeza kwishyura kanda *182*7*1#</h1>
